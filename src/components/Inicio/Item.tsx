...
const Item: React.FC<ItemProps> = ({textoItem, imagenItem, direccionarItem})  => {
  ...
  const handleClick = () => {
    ...
    return (
      <>
        <div className="mx-auto flex items-center flex-col container bg-white p-5 rounded-2xl border-2 border-gray-300 cursor-pointer hover:bg-gray-100" onClick={handleClick}>
